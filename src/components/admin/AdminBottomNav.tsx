...
export default function AdminBottomNav({ active, onChange, userRole }: Props) {
  ...
  return (
    <nav
      ...
      role="tablist"
    >
      <div className="max-w-2xl mx-auto flex overflow-x-auto no-scrollbar scroll-smooth">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className="flex-none w-[72px] flex flex-col items-center justify-center py-2.5 gap-0.5 transition-colors"
            >
              <Icon
