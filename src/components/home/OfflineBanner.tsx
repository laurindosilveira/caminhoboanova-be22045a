...
export default function OfflineBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] bg-secondary text-secondary-foreground px-4 py-2.5 flex items-center justify-center gap-2 shadow-lg animate-in slide-in-from-top duration-300">
