...
export type Course = { id: string; order_num: number; title: string; subtitle: string | null; track_id: string | null; lessons: Lesson[]; modules: Module[] };
export type LearningTrack = { id: string; name: string; description: string; order_num: number };
